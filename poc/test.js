...
function test() {
    ...
    // test4();// os dois carts têm a mesma lista e os mesmos itens, o primeiro deles dá update à quantidade
    // test5(); // os dois carts têm a mesma lista e os mesmos itens, o segundo deles dá update à quantidade
    test6(); // os dois carts têm a mesma lista, mas com itens não sincronizados
}
